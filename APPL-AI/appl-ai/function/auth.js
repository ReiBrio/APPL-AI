...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (forgotForm) {
        forgotForm.addEventListener('submit', function(e) {
            ...
            document.getElementById('forgotContainer').classList.add('formHidden');
            document.getElementById('resetContainer').classList.remove('formHidden');
        });
    }
